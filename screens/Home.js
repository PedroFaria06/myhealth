    ...
    return (
      <View style={estilos.main}>
          ...
          <View style={estilos.aCard}>
              <TouchableOpacity onPress={goToEditar} style={estilos.card}>
                  <Text style={estilos.title}>BCG</Text>
                  <View style={estilos.cardContainer}>
                      <Text style={estilos.cardContainer.text}>Dose única</Text>
                  </View>
                  <Text>11/06/2022</Text>
                  <View style={estilos.imgCard}>
                      <Image source={require('../imagem/ComprovanteVacina.jpg')} style={estilos.imgVac} />
                  </View>
              ...
              <TouchableOpacity onPress={goToEditar} style={estilos.card}>
                  <Text style={estilos.title}>Febre amarela</Text>
                  <View style={estilos.cardContainer}>
                      <Text style={estilos.cardContainer.text}>1a. dose</Text>
                  </View>
              ...
              <TouchableOpacity onPress={goToEditar} style={estilos.card}>
                  <Text style={estilos.title}>Hepatite B</Text>
                  <View style={estilos.cardContainer}>
                      <Text style={estilos.cardContainer.text}>1a. dose</Text>
                  </View>
              ...
              <TouchableOpacity onPress={goToEditar} style={estilos.card}>
                  <Text style={estilos.title}>Poliomelite</Text>
                  <View style={estilos.cardContainer}>
                      <Text style={estilos.cardContainer.text}>1a. dose</Text>
                  </View>
                  <Text>11/08/2022</Text>
